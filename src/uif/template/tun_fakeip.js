...
export var DEFAULT_DNS_LOCAL = "udp://8.8.8.8"
export var DEFAULT_DNS_REMOTE = "udp://8.8.8.8"
...
function SetOutboud(res, boundConfig, isShare) {
...
function AddRouteList(res, routeList, isShare) {
...
function SetDNS(res, uifConfig, isShare) {
...
function BuildClientSubnet(res, uifConfig, isShare) {
...
function BuildCoreConfig(uifConfig, boundConfig, useHttpApi, isShare) {
...
export function BuildShareCoreConfig(uifConfig, boundConfig) {
  ...
  // prepare inbound
  var tunIn = newDefaultTunIn(uifConfig.share.tunShareMode)
  tunIn['enabled'] = true
